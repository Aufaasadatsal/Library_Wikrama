...
<div class="bg-white text-gray-800 p-6 rounded-lg shadow-lg w-full">
    ...
    <form action="{{ route('admin.update-bukutamu', $bukutamu->id)}}" method="POST" enctype="multipart/form-data" class="space-y-6">
        @csrf
        @method('PUT')
        <!-- Tanggal -->
        <div class="space-y-2">
            ...
            <input type="date" id="tanggal" name="tanggal"
                class="w-full p-2 border border-gray-300 rounded focus:outline-none focus:border-blue-500" value="{{ $bukutamu->tanggal }}" required>
        </div>
